...
public class Logout {
    public static void main(String[] args) {
        try (Playwright playwright = Playwright.create()) {
            ...
            page.locator("a").filter(new Locator.FilterOptions().setHasText(Pattern.compile("^NM$"))).click();
            page.locator("a").filter(new Locator.FilterOptions().setHasText("Log out")).click();
